...
namespace gpupath {
    ...
    /**
     * @brief Compute unweighted shortest-path lengths for multiple sources on raw CSR.
     *
     * Convenience overload that constructs a prepared native CSR graph internally
     * and delegates to the prepared-graph overload.
     *
     * @param num_vertices Number of vertices.
     * @param indptr CSR row-pointer array.
     * @param indices CSR column-index array.
     * @param sources Source vertices.
     * @param targets Optional target subset.
    ...
    /**
     * @brief Compute weighted shortest-path lengths for multiple sources on raw CSR.
     *
     * Convenience overload that constructs a prepared native CSR graph internally
     * and delegates to the prepared-graph overload.
     *
     ...
     * @param indptr CSR row-pointer array.
     * @param indices CSR column-index array.
     * @param weights Optional edge-weight array parallel to @p indices.
     * @param sources Source vertices.
     * @param targets Optional target subset.
     * @param num_threads Requested thread count.
     *
